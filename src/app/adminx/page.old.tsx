    ...
    try {
      ...
      setStats([
        ...
        },
        {
          ...
          value: Array.isArray(configs.configurations) ? configs.configurations.length.toString() : '0',
          change: Array.isArray(configs.configurations) && configs.configurations.length > 0 ? 'Active configs' : 'No configs yet',
          changeType: Array.isArray(configs.configurations) && configs.configurations.length > 0 ? 'positive' : 'neutral',
          icon: Settings
        }
      ]);
        ...
        setRecentActivity([
          {
            ...
            description: 'Customer Support Flow v2.1',
          ...
          },
          {
            ...
            description: 'Simplified CV Questions',
          ...
          },
          {
            ...
            type: 'flow_updated',
            title: 'Flow Updated',
            description: 'Welcome Flow - Added new conditions',
            timestamp: '1 day ago',
            icon: GitBranch
          }
        ]);
